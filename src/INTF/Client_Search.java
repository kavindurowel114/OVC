 ...
 * @author KaviRox
 */
public class Client_Search extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Payments Type");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 260, -1, 20));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 220, 70, -1));
        ...
        textFieldCM1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                textFieldCM1KeyPressed(evt);
            }
        });
        jPanel1.add(textFieldCM1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 50, 90, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel13.setText("Membership Payments");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, -1, 20));
        jPanel1.add(image, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 290, 130, 70));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            s.executeUpdate("UPDATE customers_lib SET name = '" + name.getText() + "',id_number = '" + idnu.getText() + "',address = '" + address.getText() + "',mobile_number = '" + mob.getText() + "',e_mail = '" + mai.getText() + "',sex = '"+se+"',auth_code = '"+jLabel10.getText()+"',payments = '"+pa+"' WHERE id = '"+textFieldCM1.getText()+"'");
    ...
    private void textFieldCM1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldCM1KeyPressed
        ...
        if (evt.getKeyCode() == 10) {
            ...
            try {
                ...
                Statement s = ovcconn.DB().createStatement();
                ResultSet rs = s.executeQuery("SELECT * FROM customers_lib WHERE id = '" + textFieldCM1.getText() + "'");
                ...
                if (rs.next()) {
                    ...
                    mai.setText(rs.getString(6));
                    idnu.setText(rs.getString(2));
                    ...
                    if (rs.getString(8).equals("Cash")) {

                        jComboBox1.setSelectedIndex(0);
                        image.setVisible(false);

                    } else if (rs.getString(8).equals("Credit Card")) {

                        jComboBox1.setSelectedIndex(2);
                        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/visa_logo_8.gif")));
                        image.setVisible(true);

                    } else if (rs.getString(8).equals("Debit Card")) {

                        jComboBox1.setSelectedIndex(1);
                        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/mastercard.png")));
                        image.setVisible(true);

                    } else if (rs.getString(8).equals("Star Points")) {

                        jComboBox1.setSelectedIndex(3);
                        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/star.jpg")));
                        image.setVisible(true);

                    }
                } else {

                    JOptionPane.showMessageDialog(this, "Enter Valid Reg.Number...!");
                    textFieldCM1.setText(null);
    ...
    }//GEN-LAST:event_textFieldCM1KeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
